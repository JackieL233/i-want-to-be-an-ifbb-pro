...
- Provides beginner-friendly equipment/action context for exercise names, including unified visual guide categories, simple instance diagrams, example movements, and look-for cues for Smith machine, cable station, dumbbells, barbell, machine, adjustable bench, pull-up/dip station, resistance band, leg press or hack squat, and bodyweight/open-station work.
