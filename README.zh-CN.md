...
- AI 复盘：把周计划、今日实际训练、每组表现、Exercise History、Progression Cue、Exercise visual guide、中文器械名、实例图提示、常见动作、Nutrition Pacing、Body Composition Guidance、Recovery Guidance、饮食、照片、健康数据和反思一起发送给模型，判断下一次训练是否加重量、加次数、保持、减少容量、替换动作、deload，或者调整热量、碳水、蛋白质、脂肪、纤维、水分和餐次安排。
