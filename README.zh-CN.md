...
- 为动作名称提供新手友好的器械/动作上下文：例如 Smith machine、Cable station、Dumbbells、Barbell、Machine、Bodyweight/open station 等统一示意类别，帮助用户知道这个动作大概对应哪种器械和动作路径。
...
- 统一动作示意：计划动作卡片和今日训练卡片都会显示简洁的器械/动作示意图，帮助不熟悉专业动作名称的用户快速识别是 Smith 机、绳索、哑铃、杠铃、固定器械还是自重/开放空间动作。
