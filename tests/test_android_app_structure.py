...
class AndroidAppStructureTest(unittest.TestCase):
    ...
    def test_ui_exposes_daily_workflows(self) -> None:
        ...
        expected_terms = [
            ...
            "First-run quick start",
            "3-minute setup",
            "Goal, split, food, health, AI key",
            "Start with recommended setup",
            "Open profile, connect health, set API",
            "一键新手启动",
            "三分钟设置",
            "目标、分化、饮食、健康、AI key",
            "使用推荐设置开始",
            ...
            "DAILY LAUNCH & CLOSEOUT",
            "Daily Launch & Closeout",
            "Morning launch",
            "Evening closeout",
            "Sync body data -> choose plan -> first meal",
            "Finish sets -> food gaps -> AI review -> tomorrow",
            "GlobalReviewReadinessCard",
            "GLOBAL REVIEW READINESS",
            "AI Review Readiness",
            "Ready to review tonight",
            "Training evidence",
            "Food evidence",
            "Body evidence",
            "Photo/API evidence",
            ...
            "TRAINING AUTOPILOT",
            "Training Autopilot",
            "Plan -> Warm up -> Work sets -> Rest -> Closeout",
            ...
            "ONE-TAP SET EXECUTION",
            "Do this set now",
            "Target reps / kg / RIR",
            "Tap complete to start AI rest",
            "Adjust actuals only if needed",
            "Complete this set + start AI rest",
            ...
            "Eat or log this meal now",
            "Photograph or describe this meal",
            "Meal target / P / C / F",
            "Log AI estimate + update remaining macros",
            "Remaining macros update immediately",
            ...
            "LIVE METRICS COACH",
            "Live Metrics Coach",
            "Sync or check this data now",
            "Today recovery signal",
            "One-tap body evidence",
            "Sync -> trend -> photo -> AI review",
            "当前身体数据教练",
            "同步或检查这些数据",
            ...
            "Live AI Review Coach",
            "Set API or run review now",
            "Evidence bundle ready",
            "One-tap AI review",
            "Setup -> evidence -> review -> apply",
            "当前 AI 复盘教练",
            "设置 API 或运行复盘",
            "QuickAiSetupCard",
            "QUICK AI SETUP",
            ...
            "hard sets",
            "meal photo",
            "showMealEstimateDetails",
            "Meal estimate details",
            "Meal estimate details folded by default",
            "Default nutrition flow stays simple",
            "Show meal estimate details",
            "Hide meal estimate details",
            ...
            "AI APPLIED TOMORROW TRAINING",
            "AI-applied tomorrow training handoff",
            "Applied split / focus / rest / gate",
            "Open Training and start the applied plan",
    ...
    def test_static_ui_preview_covers_core_app_workflows(self) -> None:
        ...
        expected_terms = [
            ...
            "今日指挥台",
            "TODAY NEXT",
            "daily-launch-closeout-card",
            "launch-closeout-grid",
            "DailyLaunchCloseoutCard",
            "DAILY LAUNCH & CLOSEOUT",
            "Daily Launch & Closeout",
            "Morning launch",
            ...
            "LIVE SET COACH",
            "Live Set Coach",
            "one-tap-set-execution-card",
            "set-execution-target-grid",
            "adjust-actuals",
            "ONE-TAP SET EXECUTION",
            "Do this set now",
            "Target reps / kg / RIR",
            ...
            "Tomorrow recovery gate",
            "Tomorrow tracking action",
            "ai-applied-tomorrow-training-card",
            "applied-tomorrow-training-receipt",
            "AiAppliedTomorrowTrainingCard",
            "AI APPLIED TOMORROW TRAINING",
            "AI-applied tomorrow training handoff",
            "Applied split / focus / rest / gate",
            ...
            "健康同步回执",
            "Body Trend Chart",
            "live-metrics-coach-card",
            "live-metrics-target",
            "live-metrics-signal-grid",
            "LiveMetricsCoachCard",
            "LIVE METRICS COACH",
            "Live Metrics Coach",
            "Sync or check this data now",
            ...
            "Prefill next meal",
            "meal-estimate-details",
            "MealEstimateDetailsToggle",
            "data-meal-estimate-toggle",
            "Meal estimate details",
            "Meal estimate details folded by default",
            "Default nutrition flow stays simple",
            "Show meal estimate details",
            ...
            "Sync today",
            "Progress photo",
            "live-ai-review-coach-card",
            "live-ai-review-target",
            "live-ai-review-evidence-grid",
            "LiveAIReviewCoachCard",
            "LIVE AI REVIEW COACH",
            "Live AI Review Coach",
            "Set API or run review now",
